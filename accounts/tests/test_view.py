...
class SendLoginEmailViewTest(TestCase):
    ...
    def test_sends_mail_to_address_from_post(self, mock_send_mail):
        ...
        self.assertEqual(from_email, 'noreply@rdlnn.org')
        self.assertEqual(to_list, ['edith@mail.com'])
    ...
    def test_create_token_associated_with_email(self):
        ...
        self.assertEqual(token.email, 'edith@mail.com')
    ...
    def test_send_link_to_login_using_token_uid(self, mock_send_mail):
        ...
        (subject, body, from_email, to_list), kwars = mock_send_mail.call_args
